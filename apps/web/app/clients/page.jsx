      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-xl border-b border-slate-100/80">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            <a href="#" onClick={() => router.push('/clients')} className="relative py-2 text-sm font-semibold text-brand-600 after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-brand-600 after:rounded-full cursor-pointer">Clients</a>
            <Link href="/features" className="text-slate-700 hover:text-brand-600 transition-colors font-medium">Features</Link>
            <Link href="/professionals" className="text-slate-700 hover:text-brand-600 transition-colors font-medium">Professionals</Link>
            <Link href="/invoicing" className="text-slate-700 hover:text-brand-600 transition-colors font-medium">Invoicing</Link>
